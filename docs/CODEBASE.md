...
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| 2026-08-23 | Hardened today’s detection and transcription changes with order-preserving semantic cache keys, ambiguous translation-prose guards, bounded Speechmatics finish/coalescing state, failed-handshake-aware reconnect budgets, stale Vosk-event gates, real-time-safe audio drop telemetry, and NDI input validation before runtime acquisition. | 5-7, 9-11, 15 |
