...
| **STT** | Local Vosk (verse-focused grammar), or Deepgram WebSocket + REST (`tokio-tungstenite`) |
...
- **Vosk** runs locally via a Python worker process with a verse-focused
  constrained grammar for fast Bible reference detection.
- **Deepgram** streams over a WebSocket using `tokio-tungstenite`, with
  ...
  Deepgram is the recommended option for full-sermon transcript fidelity.
